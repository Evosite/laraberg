...
namespace Evosite\Laraberg\Services;

use Illuminate\Support\Facades\Cache;
use Illuminate\Support\Facades\Http;
use Illuminate\Support\Arr;
use Evosite\Laraberg\Exceptions\OEmbedFetchException;
...
class OEmbedService
{
    ...
    {
        $first = Arr::first($this->getProviders(), fn($arr, $regex) => preg_match($regex, $url));
    ...
    protected function getProviders(): array
    {
        ...
        return [
            ...
            '#https?://(www\.|embed\.)?ted\.com/talks/.*#i' => [
                'https://www.ted.com/services/v1/oembed.{format}', true
            ],
            ...
            '#https?://([a-z0-9-]+\.)?amazon\.(com|com\.mx|com\.br|ca)/.*#i' => [
                'https://read.amazon.com/kp/api/oembed', true
            ],
            '#https?://([a-z0-9-]+\.)?amazon\.(co\.uk|de|fr|it|es|in|nl|ru)/.*#i' => [
                'https://read.amazon.co.uk/kp/api/oembed', true
            ],
            '#https?://([a-z0-9-]+\.)?amazon\.(co\.jp|com\.au)/.*#i' => [
                'https://read.amazon.com.au/kp/api/oembed', true
            ],
